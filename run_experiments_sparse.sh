...
python -m smooth.scripts.imitation_learning --epochs 70000 --n_train 100000 --n_test 1000 --bs 1024 --lr 0.025 --heat_kernel_t 0.1 --clamp 0.09  --algorithm LaplacianRegularizationEuclideanSparse --regularizer 0.00001 
